                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="index.php?p=category" method="post" style="display: inline;">
                                ...
                                <button type="submit" name="edit" class="btn btn-outline-danger m-2">Edit</button>
                            </form>
                            <!-- Delete Form -->
                            <form action="index.php?p=category" method="post" style="display: inline;">
                                <input type="hidden" name="id" value="<?= $row['catid']; ?>">
                                <button type="submit" name="delete" class="btn btn-outline-success m-2">Delete</button>
                            </form>
                        </td>
                    </tr>
                <?php } ?>
