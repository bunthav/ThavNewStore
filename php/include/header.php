	...
	<header class="header-v3">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop p-l-45">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li>
								<a href="index.php" <?php echo ($p == "home" ? 'class="active"' : ''); ?>>Home</a>
							</li>

							<li>
								<a href="index.php?p=products" <?php echo ($p == "products" ? 'class="active"' : ''); ?>>Shop</a>
							</li>
							...
							<li>
								<a href="index.php?p=blog" <?php echo ($p == "blog" ? 'class="active"' : ''); ?>>Blog</a>
							</li>

							<li>
								<a href="index.php?p=about" <?php echo ($p == "about" ? 'class="active"' : ''); ?>>About</a>
							</li>
		...
		<div class="menu-mobile">
			<ul class="main-menu-m">
				...
				<li><a href="shoping-cart.php" class="label1 rs1" data-label1="hot">Features</a>
				</li>
